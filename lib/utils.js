...
var buildShareFile = function buildShareFile(_ref3) {
  ...
  var content = ['BEGIN:VCALENDAR', 'VERSION:2.0'].concat(_toConsumableArray(vtimezone ? [vtimezone] : []), ['BEGIN:VEVENT', "URL:".concat(document.URL), 'METHOD:PUBLISH', // TODO: Will need to parse the date without Z for ics
